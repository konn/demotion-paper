...
In the above example, \hask{Member k ks} and \hask{HasFactor (h a) (UnionedRecord h ls rs)} are the such constraints, witnessed by \hask{Index k ks} and \hask{IndexUnion k ls rs}, and such witnesses can be computed by \hask{FindIndex' k ks} and \hask{UnionedIndex' k ls rs}, respectively.
