...
Carefully analysing first two cases, one can realise that there are additional type-level constraints introduced by \hask{Refl} GADT constructor:
...
Here, we have two type-level functions: newly defined one, \hask{GCD_}, is the main loop implementing Euclidean algorithm.
