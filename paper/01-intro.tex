...
\begin{itemize}
  \item In \Cref{sec:gcd}, taking a type-level GCD as an example, we demonstrate how to \emph{demote} closed type-level functions involving pattern-matchings.
  ...
  \item \Cref{sec:plugins} shows a practical example of a dependently-typed plugin system type-checkable dynamically at runtime.
...
% FIXME: Change to URL after review
