...
A complete working implementation is available \ifbool{maingo}{at the support repository~\cite{demotion-repo}}{as the supplementary tarball}.
...
\hask{Sing a} can be identified with a type \hask{a} but demoted to the expression-level.
