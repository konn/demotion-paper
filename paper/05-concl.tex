...
For example, we can use \hask{Reified} class with default instances instead of \hask{Given} to switch selection strategies based on phantom type parameters.
