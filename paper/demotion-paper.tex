...
\documentclass[sigplan,%
  \ifbool{arxiv}{noacm}{\ifbool{final}{}{review}}
]{acmart}
\usepackage{subfiles}
\input{config}
\input{syntax}
...
\begin{acks}
\ifbool{maingo}{%
Many of techniques presented in this paper has been found while developing products at DeepFlow, Inc.
I thank my employer and colleagues for fruitful discussions and their challenging spirit which allows me to use type-level features so agressively.
}{%
